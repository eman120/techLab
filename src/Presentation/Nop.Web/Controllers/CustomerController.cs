...
namespace Nop.Web.Controllers
{
    ...
    public partial class CustomerController : BasePublicController
    {
        ...
        public CustomerController(IRepoClass repoClass,
        ...
        public virtual async Task<IActionResult> Register(RegisterModel model, string returnUrl, bool captchaValid, IFormCollection form)
        {
            ...
            if (_repoClass.CheckMail(model.Email))
            {
                ModelState.AddModelError("", "Email already exists in CRM");
                //return View(model);
            }
            if (ModelState.IsValid)
            {
                ...
                if (registrationResult.Success)
                {
                    ...
                    switch (_customerSettings.UserRegistrationType)
                    {
                        ...
                        case UserRegistrationType.Standard:
                            ...
                            var creat = _repoClass.CreateContact(model.FirstName, model.LastName, model.Email);
