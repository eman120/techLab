...
using Factories = Nop.Web.Factories;
...
namespace Nop.Web.Infrastructure
{
    ...
    public class NopStartup : INopStartup
    {
        ...
        {
            services.AddScoped<Factories.IRepoClass, Factories.RepoClass>(); 
            ...
            services.AddScoped<Areas.Admin.Factories.ITopicModelFactory, TopicModelFactory>();
